...
const PLANS: Record<PlanId, Plan> = {
  core: {
    ...
    tagline: "Guided self-serve · per room",
    priceCents: 19000,
    includes: [
      "We hand-hold you through writing the scope",
      ...
      "Checklist of questions to ask every contractor",
      "Next-step roadmap so you always know what''s next",
      "Email Q&A while you''re writing your scope",
  ...
  guided: {
    id: "guided",
    name: "Groundwork Pro",
    tagline: "1:1 contractor advisor · per room",
    priceCents: 59000,
    includes: [
  ...
  premium: {
    ...
    tagline: "Concierge — we run point · per room",
    priceCents: 169000,
    includes: [
      ...
      "Mid-build decision support — text us anytime, reply <24 hrs",
      "Honest read on contractor performance throughout",
